...
for i=1:NumFiles
   ...
   imD2=imD;
   imD2.DatasetName=strcat(filename(1:tag-1),'radialDensity');
   ...
   imD2.DatasetName=strcat(filename(1:tag-1),'proportionalDensity');
   imD2.Dimensions=[n_theta, radial_length, numChannels];
   ...
   saveas(fig1,strcat(filename(1:tag-1), 'Bounds.jpg'));
...
saveas(fig3, 'DensitiesOverlay2.jpg');
