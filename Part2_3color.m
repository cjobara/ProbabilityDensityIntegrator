...
for i=1:NumFiles
   ...
   imD2=imD;
   imD2.DatasetName=strcat(filename(1:u-2),'radialDensity');
   ...
   imD2.DatasetName=strcat(filename(1:u-2),'proportionalDensity');
   imD2.Dimensions=[n_theta, radial_length, numChannels];
   ...
   saveas(fig1,strcat(filename(1:u-2), 'Bounds.jpg'));
